...
- **NEVER write dependencies in the description.** Dependencies MUST be linked via `dependency_add` — never listed in the description text.
- Do not embed checklist steps in the description
...
- **NEVER write dependencies in the description** — always use `dependency_add` to link them
