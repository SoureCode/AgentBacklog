...
- **NEVER write dependencies in the description.** If a task's description lists dependencies as text, move them to proper links via `dependency_add` and remove the text.
